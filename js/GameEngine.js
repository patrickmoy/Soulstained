/**
 * Game Engine for the {Working Title} Game Copied from Seth Ladd's Game
 * Development Talk on Google IO 2011 Modified to work with our game.
 */
...
class GameEngine
{
	...
	// If button is pressed and the button is a key we care about,
	// set it to true.
	...
	// If button is lifted from press and the button is a key we
	// care about, set it to false.
